...
(function (factory) {
  ...
  var TableResultAction = function (startPoint, where, action, domTable) {
    ...
    /**
     * Define virtual table position impl object.
     * 
    ...
    /**
     * Recover impl about row and cell and add information to virtual table.
     * 
  ...
  var Handle = function (context) {
    ...
    this.initialize = function () {
      this.$handle = $([
        ...
        ' note-control-se"></div>',
        (options.disableResizeImage ? '' : '<div class="note-control-selection-impl"></div>'),
        '</div>',
        '</div>'
    ...
    this.update = function (target) {
      ...
      if (isImage) {
        ...
        $selection.find('.note-control-selection-impl').text(sizingText);
