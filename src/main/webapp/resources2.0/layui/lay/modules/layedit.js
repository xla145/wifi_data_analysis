...
layui.define(['layer', 'form'], function(exports){
  ...
  //全部工具
  ,tools = {
    html2: '<select style="width: 60px;height: 20px;font-size: 12px;"><option value=10>10px</option><option value=12>12px</option><option value=14>14px</option><option value=16>16px</option><option value=18>18px</option><option value=20>20px</option><option value=22>22px</option><option value=24>24px</option></select>'
